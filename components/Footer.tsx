      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-white font-semibold">Uche Edwin</span>
            </Link>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="p-3 bg-neutral-900 rounded-lg text-neutral-400 hover:text-white hover:bg-neutral-800 transition-colors"
        ...
        <div className="mt-12 pt-8 border-t border-neutral-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-neutral-400 text-sm flex items-center">
            Built with Next.js &amp;{' '}
            <Heart size={14} className="mx-1 text-white fill-white" />
          </p>
        </div>
      </div>
    </footer>
